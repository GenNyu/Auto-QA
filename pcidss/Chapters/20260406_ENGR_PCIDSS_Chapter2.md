...
| Account Data Type | Data Elements                  | Storage Restrictions                                                                 | Required to Render Stored Data Unreadable |
|------------------|-------------------------------|--------------------------------------------------------------------------------------|------------------------------------------|
...
|                  | Expiration Date              | Storage is kept to a minimum as defined in Requirement 3.2²                         | No                                       |
...
|                  | Card verification code (CVC) | Cannot be stored after authorization as defined in Requirement 3.3.1³               | Yes (same as above)                      |
|                  | PIN/PIN Block               | Cannot be stored after authorization as defined in Requirement 3.3.1³               | Yes (same as above)                      |
